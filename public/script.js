            ...
            if (isValid) {
                ...
                .then(function(response) {
                    if (response.ok) {
                        ...
                        successMessage.style.cssText = 'color: #28a745; padding: 1rem; margin-top: 1rem; border: 1px solid #28a745; border-radius: 4px;';
                ...
                .catch(function(error) {
                    ...
                    errorMessage.style.cssText = 'color: #dc3545; padding: 1rem; margin-top: 1rem; border: 1px solid #dc3545; border-radius: 4px;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'cf34872c-4d24-41f1-a85f-ea0d63cca7e1',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'cf34872c-4d24-41f1-a85f-ea0d63cca7e1';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'cf34872c-4d24-41f1-a85f-ea0d63cca7e1';
